...
amRml is part of the [amR suite](https://github.com/JRaviLab/amR) for antimicrobial resistance prediction. amRml is the machine learning (ML) engine of the https://github.com/JRaviLab/amR.
It trains interpretable ML models to predict antimicrobial resistance (AMR) from the multi‑scale genomic features prepared by amRdata.
...
See the https://jravilab.github.io/amRml/articles/intro.html for full examples.
...
generateMLInputs() converts the Parquet‑backed DuckDB file created by amRdata into a standard set of ready-to-model matrices.
```r
library(amRml)
