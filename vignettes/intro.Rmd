...
```{r generate-matrices, eval = FALSE}
generateMLInputs(
...
```{r plot-prc, eval = FALSE, fig.width = 5, fig.height = 4}
plotPRC(results$pred)
```

```{r plot-vi, eval = FALSE, fig.width = 5, fig.height = 4}
plotTopFeatsVI(results$top_feat_tibble, n_top_feats = 10)
```
...
```{r plot-fishers, eval = FALSE, fig.width = 5, fig.height = 4}
